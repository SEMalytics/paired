# PAIRED (Platform for AI-Enabled Remote Development) - Philosophical Foundation

> **Important Note**: PAIRED (Platform for AI-Enabled Remote Development) is an independent project that enhances development workflows within the Windsurf IDE. PAIRED is not affiliated with or endorsed by Codeium (makers of Windsurf IDE). Windsurf® is a trademark of Codeium.
...
Traditional development treats code as static instructions. The PAIRED philosophy recognizes code as a **living, breathing ecosystem** that:
...
This philosophy is not just documentation—it's our operating system. Every PAIRED agent embodies these principles in their daily work:
...
*The PAIRED (Platform for AI-Enabled Remote Development) philosophy transforms software development from a technical discipline into a comprehensive approach to intelligent, adaptive, continuously learning creation.*
