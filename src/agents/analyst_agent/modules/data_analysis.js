...
class DataAnalysis {
  ...
  async loadExistingAnalyses() {
    try {
      const analysisDir = path.join(process.cwd(), '.wee', 'agents', 'analyst', 'data_analysis');
  ...
  async ensureDirectories() {
    const dirs = [
      path.join(process.cwd(), '.wee', 'agents', 'analyst', 'data_analysis'),
      path.join(process.cwd(), '.wee', 'agents', 'analyst', 'data_analysis', 'reports')
    ];
