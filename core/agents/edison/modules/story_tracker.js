...
class StoryTracker {
  constructor(agent) {
    ...
    this.trackingFile = path.join(projectRoot, 'core/agents/edison/tracking/story_progress.md');
  }
  ...
  async estimateAffectedFiles(story, analysis) {
    ...
    files.push(`core/components/${baseFileName}.js`);
    files.push(`shared/services/${baseFileName}_service.js`);
