...
const EnhancedAgentFactory = require('../core/agents/enhanced_agent_factory');
...
class AgentLauncher {
  ...
  async initialize() {
    ...
    // Initialize enhanced agent factory with null orchestrator (standalone mode)
    this.factory = new EnhancedAgentFactory(null);
